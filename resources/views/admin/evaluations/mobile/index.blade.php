{{-- resources/views/admin/evaluations/mobile/index.blade.php --}}
@extends('layouts.app')
@section('content')
...
<div class="page-inner">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4" style="margin-top: 67px;">
        ...
        <!-- <a href="{{ route('admin.evaluations.mobile.export') }}"
    ...
    <div class="card shadow-sm border-0" style="border-radius:14px;overflow:hidden;">
        <div class="card-body p-4">
            ...
            {{-- Filters Bar --}}
            <form method="GET" action="{{ route('admin.evaluations.mobile.index') }}"
                ...
                <table class="table eval-table align-middle mb-0">
                    <thead>
                        <tr>
                            ...
                            {{-- ✅ Replaced Defects/Accessories with checkout columns --}}
                            <th>Pickup Slot</th>
                            <th>Payment</th>
                            <th>Est. Price</th>
                            <th>Date</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    @else
                                        <div style="width:28px;height:28px;background:#e3f2fd;border-radius:6px;
                                            ...
                                            <i class="fas fa-mobile-alt" style="color:#1565c0;font-size:13px;"></i>
                                        </div>
                                    @endif
                                    <div>
                            ...
                            <!-- {{-- Variant --}}
                            <td>
                                <span class="badge-pill-custom" style="background:#e8f5e9;color:#2e7d32;">
                                    {{ $eval->variant->memory ?? '—' }}
                                </span>
                            </td> -->
                            ...
                            {{-- ✅ Action — view only, no delete --}}
                            <td>
                                <a href="{{ route('admin.evaluations.mobile.show', $eval->id) }}"
...
.eval-stat-icon { font-size: 26px; opacity: .25; position: absolute; right: 18px; top: 18px; }
