...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Edit Model</h3>
            <ul class="breadcrumbs mb-3">
                ...
                <li class="separator"><i class="icon-arrow-right"></i></li>
                <li class="nav-item"><a href="#">Edit Model</a></li>
            </ul>
        </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Edit: {{ $model->name }}</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('brands.models.update', [$brand->id, $model->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf @method('PUT')
