{{-- resources/views/sell/laptop/quote.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<div class="quote-wrap">
    ...
    <div class="quote-grid">
        ...
        <div>
            <div class="quote-main-card">
                ...
                <div class="quote-actions">
                    <a href="{{ route('sell.laptop.checkout', $data['evaluation_id']) }}" class="btn-sell-now">
                        Sell Now
                    ...
                    <a href="{{ route('sell.laptop.brand.models', $data['brand_slug']) }}" class="btn-recalculate">
                        Recalculate
                    </a>
                </div>
            </div>
        ...
        <div class="quote-sidebar">
            <!-- @php $verified = session('laptop_otp_verified'); @endphp
            @if($verified)
